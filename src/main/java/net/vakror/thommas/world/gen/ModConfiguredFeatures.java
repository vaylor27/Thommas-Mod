...
public class ModConfiguredFeatures {
    ...
    public static final RegistryEntry<ConfiguredFeature<LakeFeature.Config, ?>> OIL =
            ConfiguredFeatures.register("oil", Feature.LAKE,
                    new LakeFeature.Config(BlockStateProvider.of(ModFluids.OIL_BLOCK.getDefaultState()), BlockStateProvider.of(ModBlocks.TWICE_COMPRESSED_STONE.getDefaultState())));
