...
public class ModCitrineArmor extends ArmorItem {
    private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP =
            (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                    .put(ModArmorMaterials.CITRINE,
                            new StatusEffectInstance(StatusEffects.STRENGTH, 200, 3)).build();

    public ModCitrineArmor(ArmorMaterial material, EquipmentSlot slot, Settings settings) {
