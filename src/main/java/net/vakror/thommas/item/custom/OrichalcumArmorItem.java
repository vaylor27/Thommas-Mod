...
public class OrichalcumArmorItem extends ModMythrilArmor implements IAnimatable {
    private final AnimationFactory factory = new AnimationFactory(this);

    public OrichalcumArmorItem(ArmorMaterial material, EquipmentSlot slot, Item.Settings settings) {
