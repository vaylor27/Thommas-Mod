...
public class LightningChannelerREICategory implements DisplayCategory<LightningChannelerREIDisplay> {
	private final EntryStack<ItemStack> altar = EntryStacks.of(new ItemStack(ModBlocks.LIGHTNING_CHANNELER_BLOCK));
	@Override
	public @NotNull CategoryIdentifier<LightningChannelerREIDisplay> getCategoryIdentifier() {
	...
	@Override
	public @NotNull List<Widget> setupDisplay(LightningChannelerREIDisplay display, Rectangle bounds) {
