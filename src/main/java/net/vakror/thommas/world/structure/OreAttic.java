...
public class OreAttic extends StructureFeature<StructurePoolFeatureConfig> {
    ...
    public OreAttic() {
        ...
        super(CODEC, OreAttic::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!OreAttic.isFeatureChunk(context)) {
