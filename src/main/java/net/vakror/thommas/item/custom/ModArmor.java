...
public class ModArmor extends ArmorItem {
    private static Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP;

    public ModArmor(ArmorMaterial material, EquipmentSlot slot, Settings settings, StatusEffect effect) {
        super(material, slot, settings);
        MATERIAL_TO_EFFECT_MAP = (new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>())
                .put(material,
                        new StatusEffectInstance(effect, 200, 2)).build();
    }
