package net.vakror.thommas.item.inventory;
 ...
 */
@FunctionalInterface
public interface MassiveImplementedInventory extends SidedInventory {
    /**
     ...
     */
    static MassiveImplementedInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static MassiveImplementedInventory ofSize(int size) {
