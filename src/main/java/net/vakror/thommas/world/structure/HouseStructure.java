...
public class HouseStructure extends StructureFeature<StructurePoolFeatureConfig> {
    ...
    public HouseStructure() {
        ...
        super(CODEC, HouseStructure::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!HouseStructure.isFeatureChunk(context)) {
