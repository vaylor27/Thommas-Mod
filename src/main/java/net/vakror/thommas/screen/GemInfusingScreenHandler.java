...
public class GemInfusingScreenHandler extends ThommasMachineScreenHandler {
    ...
    public GemInfusingScreenHandler(int syncId, PlayerInventory playerInventory, BlockEntity entity, PropertyDelegate delegate) {
        super(ModScreenHandlers.GEM_INFUSING_SCREEN_HANDLER, syncId, playerInventory, entity, delegate);
