...
public class AbandonedOreAttic extends StructureFeature<StructurePoolFeatureConfig> {
    ...
    public static final Codec<StructurePoolFeatureConfig> CODEC = RecordCodecBuilder.create(
        instance -> instance.group(
            ...
            Codec.intRange(0, 47).fieldOf("size").forGetter(StructurePoolFeatureConfig::getSize)
        )
        .apply(instance, StructurePoolFeatureConfig::new)
    );

    public AbandonedOreAttic() {
        // Create the pieces layout of the structure and give it to the game
        super(CODEC, AbandonedOreAttic::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!AbandonedOreAttic.isFeatureChunk(context)) {
        ...
        if(structurePiecesGenerator.isPresent()) {
            ...
            Thommas.LOGGER.debug("Rundown House at {}", blockpos);
        }
