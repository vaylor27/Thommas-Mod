...
public class ModOreGen {
    public static void generateOres() {
        ...
        new Ore("netherrack_mythril", Blocks.NETHERRACK, 2, 26, false);
        new Ore("deepslate_mythril", Blocks.DEEPSLATE, 9, 4, false);
        new Ore("mythril", Blocks.STONE, 8, 9, false);
        ...
        new Ore("crimtane", Blocks.STONE, 4, 2);
        new Ore("nether_demonite", Blocks.BASALT, 4,8, false);
        ...
        new Ore("platinum", Blocks.STONE, 1, 10, false);
        new Ore("saltpeter", Blocks.SANDSTONE, 3, 5);
        new Ore("sapphire", Blocks.STONE, 6, 3);
        new Ore("silver", Blocks.STONE, 1, 54);
        new Ore("sulphur", Blocks.STONE, 3, 5);
        new Ore("titanium", Blocks.STONE, 2, 5);
        new Ore("topaz", Blocks.STONE, 2, 5);
        new Ore("tungsten", Blocks.STONE, 4, 7);
        new Ore("endstone_citrine", Blocks.STONE, 26, 3, false);
        new Ore("salt", Blocks.SANDSTONE, 40, 9, false);
        new Ore("stone_zinc", Blocks.STONE, 23, 6);
        new Ore("big_stone_auricupride", Blocks.STONE, 8, 9);
        new Ore("big_stone_bauxite", Blocks.STONE, 8, 9);
        new Ore("big_stone_cylindrite", Blocks.STONE, 8, 9);
        new Ore("big_stone_gahnite", Blocks.STONE, 8, 9);
        new Ore("big_stone_galena", Blocks.STONE, 8, 9);
        new Ore("big_stone_pentlandite", Blocks.STONE, 8, 9, false);
        new Ore("big_stone_sphalerite", Blocks.STONE, 8, 9, false);
        new Ore("dirt_lignite", Blocks.DIRT, 8, 9);
        new Ore("dirt_metal", Blocks.DIRT, 8, 9);
        ...
        new Ore("netherrack_perfidum", Blocks.NETHERRACK, 8, 9);
        new Ore("red_sand_lignite", Blocks.RED_SAND, 8, 9);
        new Ore("sand_lignite", Blocks.SAND, 8, 9);
        new Ore("sand_oil", Blocks.SAND, 8, 9);
        new Ore("slade_bones_0", ModBlocks.SLADE_NORMAL, 8, 9,false);
        new Ore("slade_bones_1", ModBlocks.SLADE_NORMAL, 8, 9,false);
        new Ore("slade_bones_2", ModBlocks.SLADE_NORMAL, 8, 9, false);
        ...
        new Ore("stone_anthracite", Blocks.STONE, 8, 9);
        new Ore("stone_bones", Blocks.STONE, 8, 9);
        new Ore("stone_brimstone", Blocks.STONE, 8, 9);
        new Ore("stone_copper", Blocks.STONE, 8, 9);
        new Ore("stone_copper_2", Blocks.STONE, 8, 9,false);
        new Ore("stone_lead", Blocks.STONE, 8, 9);
        new Ore("stone_lead_2", Blocks.STONE, 8, 9,false);
        new Ore("stone_saltpeter", Blocks.STONE, 8, 9);
