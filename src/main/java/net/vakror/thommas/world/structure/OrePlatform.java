...
public class OrePlatform extends StructureFeature<StructurePoolFeatureConfig> {
    ...
    public OrePlatform() {
        ...
        super(CODEC, OrePlatform::createPiecesGenerator, PostPlacementProcessor.EMPTY);
    }
    ...
    public static Optional<StructurePiecesGenerator<StructurePoolFeatureConfig>> createPiecesGenerator(StructureGeneratorFactory.Context<StructurePoolFeatureConfig> context) {
        ...
        if (!OrePlatform.isFeatureChunk(context)) {
